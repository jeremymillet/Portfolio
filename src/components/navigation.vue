...
.nav-link {
    ...
    letter-spacing: 3px;
    text-decoration: none;
    text-shadow: 3px 3px 0 #759BFD, -1px -1px 0 #759BFD, 1px -1px 0 #759BFD, -1px 1px 0 #759BFD, 1px 1px 0 #759BFD;
}
